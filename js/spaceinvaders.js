...
grapefruit = new Image();
grapefruit.src = "images/grapefruit.svg";

blackboard = new Image();
blackboard.src = "images/blackboard.png";
...
PlayState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.drawImage(grapefruit,this.ship.x - (this.ship.width / 2), this.ship.y - (this.ship.height / 2), this.ship.width, this.ship.height);
    ...
    for(var i=0; i<this.invaders.length; i++) {
        ...
        ctx.drawImage(blackboard,invader.x - invader.width/2, invader.y - invader.height/2, invader.width, invader.height);
    }
